...
function SwatchPreview({ preview }: { preview: SwatchOption["preview"] }) {
  if (preview.type === "gradient") {
    return <div className="size-8 rounded-md border" style={{ background: preview.css }} />;
  }
  if (preview.type === "palette") {
    return (
      <div className="flex size-8 overflow-hidden rounded-md border">
  ...
  return (
    <div className="relative size-8 rounded-md border bg-muted">
      <div
